...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  const tombAddr = tombFinance.SOMB.address;
  const tshareAddr = tombFinance.SSHARE.address;

  let pairName: string;
  let uniswapUrl: string;
  if (bank.depositTokenName.includes('SOMB')) {
    pairName = 'SOMB-FTM pair';
    uniswapUrl = 'https://spookyswap.finance/add/FTM/' + tombAddr;
  } else {
    pairName = 'SSHARE-FTM pair';
