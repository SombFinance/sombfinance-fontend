  ...
  return (
    <Modal>
      ...
      >
        ...
        <StyledMenuItem value={TSHARE_TICKER}>SSHARE</StyledMenuItem>
        {/* Somb as an input for zapping will be disabled due to issues occuring with the Gatekeeper system */}
        {/* <StyledMenuItem value={TOMB_TICKER}>SOMB</StyledMenuItem> */}
      </Select>
      <TokenInput
