...
import CashImage from '../../assets/img/somb.png';
...
const Home = () => {
  ...
  const tombFtmLpStats = useLpStats('SOMB-FTM-LP');
  ...
  const tombLpZap = useZap({ depositTokenName: 'SOMB-FTM-LP' });
  const tshareLpZap = useZap({ depositTokenName: 'SSHARE-FTM-LP' });
    ...
    <Page>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={8}>
          <Paper>
            <Box p={4}>
              <h2>Welcome to Somb Finance</h2>
              <p>The first algorithmic stablecoin on Fantom Opera, pegged to the price of 1 FTM via seigniorage.</p>
              <p>
                Stake your $SOMB-$FTM LP in the Cemetery to earn $SSHARE rewards.
                Then stake your earned $SSHARE in the Masonry to earn more $SOMB!
              </p>
            </Box>
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center" style={{ position: 'relative' }}>
              ...
              <Button
                onClick={() => {
                  tombFinance.watchAssetInMetamask('SOMB');
                }}
                color="primary"
                variant="outlined"
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center" style={{ position: 'relative' }}>
              ...
              <Button
                onClick={() => {
                  tombFinance.watchAssetInMetamask('SSHARE');
                }}
                color="primary"
                variant="outlined"
                style={{ position: 'absolute', top: '10px', right: '10px' }}
        ...
        <Grid item xs={12} sm={6}>
          <Card>
            <CardContent align="center">
              <h2>SOMB-FTM Spooky LP</h2>
              <Box mt={2}>
                <CardIcon>
                  <TokenSymbol symbol="SOMB-FTM-LP" />
                </CardIcon>
              </Box>
              <Box mt={2}>
              ...
              <Box mt={2}>
                <span style={{ fontSize: '26px' }}>
                  {tombLPStats?.tokenAmount ? tombLPStats?.tokenAmount : '-.--'} SOMB /{' '}
        ...
        <Grid item xs={12} sm={6}>
          <Card>
            <CardContent align="center">
              <h2>SSHARE-FTM Spooky LP</h2>
              <Box mt={2}>
                <CardIcon>
                  <TokenSymbol symbol="SSHARE-FTM-LP" />
                </CardIcon>
              </Box>
              <Box mt={2}>
              ...
              <Box mt={2}>
                <span style={{ fontSize: '26px' }}>
                  {tshareLPStats?.tokenAmount ? tshareLPStats?.tokenAmount : '-.--'} SSHARE /{' '}
