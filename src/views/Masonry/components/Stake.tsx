...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(tombFinance.SSHARE, tombFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(tombFinance.SSHARE);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('SSHARE', tombFinance.SSHARE);
