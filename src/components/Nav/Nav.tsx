        ...
        {matches ? (
          <>
            <Typography variant="h6" color="inherit" noWrap className={classes.toolbarTitle}>
              {/* <a className={ classes.brandLink } href="/">Somb Finance</a> */}
            ...
            <Box mr={5}>
              ...
              <a href="https://docs.somb.finance" className={classes.link}>
                Docs
              </a>
            </Box>
          ...
          <>
            ...
            >
              ...
              <List>
                ...
                <ListItem button component="a" href="https://docs.somb.finance">
