      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{ textAlign: 'right' }}>
            <a
              href="https://twitter.com/sombfinance"
            ...
            <a
              href="https://github.com/sombfinance/sombfinance-frontend"
              rel="noopener noreferrer"
              target="_blank"
              className={classes.link}
            >
            ...
            <a href="https://t.me/sombfinance" rel="noopener noreferrer" target="_blank" className={classes.link}>
