...
const HiddenAccordion: React.SFC<HiddenProps> = ({hidden, tittle}) => {
    ...
    return ( 
        <div className="hidden-info hidden" ref={hidden}>
                ...
                <p>You will recieve miniTSHLP as a receipt for your deposited SSHARE-FTM LP Pool access. this token is needed to withdraw your SSHARE-FTM LP, do not trade or transfer miniTSHLP to strangers!</p>
            </ContainerOpen>
            <ContainerOpen>
